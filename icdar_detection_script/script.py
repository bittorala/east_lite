...
import icdar_detection_script.rrc_evaluation_funcs_1_1 as rrc_evaluation_funcs
import importlib
...
def main(s_path):
    return rrc_evaluation_funcs.main_evaluation({'g': 'icdar_detection_script/gt.zip', 's': s_path},default_evaluation_params,validate_data,evaluate_method)
